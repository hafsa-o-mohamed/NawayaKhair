    ...
    <section class="bg-white">
        <div class="grid max-w-screen-xl h-screen py-8 px-4  mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
            <div class="mr-auto place-self-center lg:col-span-7">
                <h1 class="max-w-2xl mb-4 font-body text-4xl font-extrabold tracking-tight leading-none md:text-5xl xl:text-6xl "> حلول تسويقية 
                   <span class="text-secondary "> فعّـالة </span>
                </h1>
                <p class="max-w-2xl mb-6 font-body font-light text-balance text-gray-500 lg:mb-8 md:text-lg lg:text-xl ">
                نقدم لكم استراتيجيات تسويق إلكتروني متكاملة لزيادة ظهورك الرقمي وتحقيق أهدافك التجارية. مع حلولنا المبتكرة في تحسين محركات البحث، التسويق عبر وسائل التواصل الاجتماعي، والإعلانات المدفوعة، ستتمكن من الوصول إلى جمهورك المستهدف وزيادة تفاعلهم مع علامتك التجارية.                </p>
                <a href="https://api.whatsapp.com/send?phone=00966508939946&text=%D9%85%D8%B1%D8%AD%D8%A8%D8%A7%D8%8C%20%D8%A3%D8%B1%D9%8A%D8%AF%20%D8%B7%D9%84%D8%A8%20%D8%AE%D8%AF%D9%85%D8%A9%20" class="inline-flex items-center justify-center px-5 py-3 mr-3 text-base font-medium text-center text-white rounded-lg border-gray-700 bg-secondary hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 ">
                    اطلب الخدمة
                </a>
...
<div class="px-4">
    <div class="h-full md:order-first"> 
        <img src="img/services/digitalmarketing.jpg" alt="#_" class="rounded-xl bg-gray-200 shadow-box shadow-gray-500/30 overflow-hidden aspect-square  w-full h-full object-cover object-center"/>
         </div>
    ...
    <div class=" px-4">
        <div class="w-full  px-4">
           <div
              ...
              نقدم حملات سوشيال ميديا مخصصة تعزز تواجدك الرقمي وتزيد من تفاعل الجمهور مع علامتك التجارية. باستخدام استراتيجيات مبدعة وتحليلات دقيقة، نساعدك على تحقيق أقصى تأثير ونتائج ملموسة.
</p>
           </div>
        </div>
        <div class="w-full  px-4">
           <div
              ...
              <p class="text-body-color">
              نقدم خدمات محتوى متميزة تشمل كتابة المحتويات بكافة أنواعها ، وتطوير الاستراتيجيات التي تعزز تواجدك الرقمي، سيتمكن  فريقنا الإبداعي من جذب جمهورك المستهدف وتحقيق أهدافك التسويقية بفعالية.
              </p>
           </div>
        </div>
        <div class="w-full  px-4">
...
<div
            ...
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1" stroke="currentColor" class="stroke-white size-12">
              ...
              <p class="text-body-color">
              ننفذ حملات مدروسة بعناية لتحقيق أقصى تأثير، من خلال تحليل دقيق لبيانات السوق واستراتيجيات موجهة. نضمن لك نتائج ملموسة عبر استهداف دقيق وتحسين مستمر لأداء الحملة.              </p>
           </div>
        </div>
      ...
      <section class="bg-white dark:bg-gray-900 font-body">
        <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
            <div class="mx-auto max-w-screen-md text-center mb-8 lg:mb-12">
                <h2 class="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">  خدمات التسويق الإلكتروني  </h2>
                <p class="mb-5 font-light text-gray-500 sm:text-xl dark:text-gray-400">أختر احتياجاتك من بين خدماتنا التسويقية الاحترافية وتواصل معنا لتحصل على عرض سعر خاص</p>
            </div>
            <div class="space-y-8 lg:grid lg:grid-cols-3 sm:gap-6 xl:gap-10 lg:space-y-0">
                ...
                <div class="flex flex-col shadow-md p-6 mx-auto max-w-lg text-center text-gray-900 bg-white rounded-lg border border-gray-100  dark:border-gray-600 xl:p-8 dark:bg-gray-800 dark:text-white">
                    <h3 class="mb-4 text-2xl font-semibold text-secondary">إعداد الخطط التسويقية  </h3>
                    ...
                    <ul role="list" class=" my-8 mb-8 space-y-4 text-left">
                        ...
                        <li class="flex items-center space-x-3">
                            {/* <!-- Icon --> */}
                            <svg class="flex-shrink-0 w-5 h-5 text-green-500 dark:text-green-400" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"></path></svg>
                            <span>إعداد التقارير الدورية </span>
                        </li>
                ...
                {/* <!-- Pricing Card --> */}
                <div class="flex flex-col shadow-md p-6 mx-auto max-w-lg text-center text-gray-900 bg-white rounded-lg border border-gray-100  dark:border-gray-600 xl:p-8 dark:bg-gray-800 dark:text-white">
                    <h3 class="mb-4 text-2xl font-semibold text-secondary">إنشاء المحتويات الإبداعية </h3>
                    ...
                    <ul role="list" class="my-8 mb-8 space-y-4 text-left">
                        <li class="flex items-center space-x-3">
                            {/* <!-- Icon --> */}
                            <svg class="flex-shrink-0 w-5 h-5 text-green-500 dark:text-green-400" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"></path></svg>
                            <span> كتابة محتوى وسائل التواصل  </span>
                        </li>
                        <li class="flex items-center space-x-3">
                            {/* <!-- Icon --> */}
                            <svg class="flex-shrink-0 w-5 h-5 text-green-500 dark:text-green-400" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"></path></svg>
                            <span> تصميم محتوى وسائل التواصل </span>
                        </li>
                        <li class="flex items-center space-x-3">
                            {/* <!-- Icon --> */}
                            <svg class="flex-shrink-0 w-5 h-5 text-green-500 dark:text-green-400" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"></path></svg>
                            <span>إعداد المحتويات التفاعلية</span>
                        </li>
                        <li class="flex items-center space-x-3">
                            {/* <!-- Icon --> */}
                            <svg class="flex-shrink-0 w-5 h-5 text-green-500 dark:text-green-400" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"></path></svg>
                            <span>إعداد الفيديوهات  </span>
                        </li>
                        <li class="flex items-center space-x-3">
                            {/* <!-- Icon --> */}
                            <svg class="flex-shrink-0 w-5 h-5 text-green-500 dark:text-green-400" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"></path></svg>
                            <span>مواكبة التريندات  </span>
                        </li>
                        <li class="flex items-center space-x-3">
                            {/* <!-- Icon --> */}
                            <svg class="flex-shrink-0 w-5 h-5 text-green-500 dark:text-green-400" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"></path></svg>
                            <span>كتابة التدوينات  والمحتويات المطولة</span>
                        </li>
                ...
                {/* <!-- Pricing Card --> */}
                <div class="flex flex-col shadow-md p-6 mx-auto max-w-lg text-center text-gray-900 bg-white rounded-lg border border-gray-100  dark:border-gray-600 xl:p-8 dark:bg-gray-800 dark:text-white">
                    <h3 class="mb-4 text-2xl font-semibold text-secondary">إطلاق الحملات المدروسة</h3>
                    <p class="font-light text-gray-500 sm:text-lg dark:text-gray-400">ندرس نموذج العمل المقدم لنقدم بين يديك تطبيقاً ناجحاً وملبياً لاحتياجات عملائك</p>
                    ...
                    <ul role="list" class=" my-8 mb-8 space-y-4 text-left">
                        <li class="flex items-center space-x-3">
                            {/* <!-- Icon --> */}
                            <svg class="flex-shrink-0 w-5 h-5 text-green-500 dark:text-green-400" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"></path></svg>
                            <span>حملات الوصول للعملاء </span>
                        </li>
                        <li class="flex items-center space-x-3">
                            {/* <!-- Icon --> */}
                            <svg class="flex-shrink-0 w-5 h-5 text-green-500 dark:text-green-400" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"></path></svg>
                            <span> حملات التوعية وبناء الثقة </span>
                        </li>
                        <li class="flex items-center space-x-3">
                            {/* <!-- Icon --> */}
                            <svg class="flex-shrink-0 w-5 h-5 text-green-500 dark:text-green-400" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"></path></svg>
                            <span>  الحملات التفاعلية </span>
                        </li>
                        <li class="flex items-center space-x-3">
                            {/* <!-- Icon --> */}
                            <svg class="flex-shrink-0 w-5 h-5 text-green-500 dark:text-green-400" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"></path></svg>
                            <span> الربط بالمتجر والحسابات الأخرى</span>
                        </li>
                        <li class="flex items-center space-x-3">
                            {/* <!-- Icon --> */}
                            <svg class="flex-shrink-0 w-5 h-5 text-green-500 dark:text-green-400" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"></path></svg>
